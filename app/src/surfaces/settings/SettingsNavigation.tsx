...
export function SettingsNavigation({
  ...
  return (
    <aside className="flex w-64 shrink-0 flex-col border-r border-border-subtle bg-bg-secondary/70">
      <div className="space-y-3 px-3 pb-3 pt-4">
        ...
        <label className="relative block">
          ...
          <input
            ...
            className="h-8 w-full rounded-lg border border-border-subtle bg-bg-sunken pl-8 pr-2.5 text-sm text-ink outline-none transition placeholder:text-ink-faint focus:border-accent focus:ring-2 focus:ring-accent/15"
          />
        </label>
      </div>
