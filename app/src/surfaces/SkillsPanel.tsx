  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/35 p-6">
      <div
        ...
        aria-modal="true"
        aria-label="Skills"
        className="flex max-h-[86vh] w-full max-w-4xl flex-col overflow-hidden rounded-3xl border border-border-subtle bg-bg-elevated shadow-lifted"
      >
          ...
          <section className="flex min-h-0 flex-col border-r border-border-subtle">
            <div className="relative m-3">
              ...
              <input
                ...
                className="h-9 w-full rounded-xl border border-border-subtle bg-bg px-9 text-sm text-ink outline-none focus:border-accent/40"
              />
            </div>
            <div className="min-h-0 flex-1 overflow-y-auto px-3 pb-3">
              ...
              {skills.map((skill) => (
                <button
                  ...
                  className="mb-1.5 flex w-full items-start gap-3 rounded-xl border border-border-subtle px-3 py-2.5 text-left transition hover:bg-bg-hover disabled:cursor-not-allowed disabled:opacity-55"
                >
