...
beforeEach(() => {
  useSessionStore.setState({
    activeProjectRoot: "/Users/stan/project",
    activeRemote: null,
  });
});
...
describe("MarkdownLink", () => {
  it("marks filesystem destinations as native local-file links", () => {
    const markup = renderToStaticMarkup(
      createElement(
        MarkdownLink,
        { href: "/Users/stan/project/docs/report.docx" },
        "Generated report",
      ),
    );

    expect(markup).toContain('data-local-file="/Users/stan/project/docs/report.docx"');
