import { LANG_ALIASES, resolveLang, highlightCacheKey } from "./highlightLanguage";
...
/** Create (once) and return the singleton core highlighter. Loads both themes with the JS regex engine; grammars load on demand. */
