...
export async function openRemote(host: SshHost, projectRoot = host.remoteRoot): Promise<RemoteInfo> {
  if (!hostReady(host)) {
...
export const codeKeyProvisions = new Map<string, Promise<string>>();
