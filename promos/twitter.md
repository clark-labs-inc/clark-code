...
Clark Code is an AI coding agent that runs on your own machine. Point it at a repo and it reads, edits, and runs your code, and keeps a memory of how the project fits together. Local, or on a remote box over SSH.
