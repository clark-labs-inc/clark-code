...
const PRODUCTION_MODEL: &str = "~deepseek/deepseek-v4-flash-latest";

#[path = "ingest/marker.rs"]
mod marker;
use marker::{marker_path, now_ms, read_matching_marker, write_marker};

pub struct SecuritySyncRequest {
    ...
    pub scanner_display_name: String,
    pub scanner_version: String,
    pub trigger: String,
    pub source: String,
}

pub async fn sync_security_scans(
...
async fn sync_one(
    ...
    let scan = client
        .create_scan(&json!({
            ...
            "scannerVersion": request.scanner_version,
