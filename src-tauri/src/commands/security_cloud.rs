...
#[tauri::command]
pub async fn desktop_security_organizations(state: State<'_, AppState>) -> Result<Value, String> {
...
pub async fn desktop_security_sync_scans(
    ...
    ingest::sync_security_scans(ingest::SecuritySyncRequest {
        ...
        scanner_display_name: "Clark Desktop Security".into(),
        scanner_version: format!("clark-desktop/{}", env!("CARGO_PKG_VERSION")),
        trigger: "desktop".into(),
        source: "clark-desktop".into(),
    })
    .await
}
