...
pub fn run_with_product_and_context(
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::provider_add_read_roots,
            commands::provider_remove_read_roots,
            ...
            commands::local_list_sibling_directories,
            ...
            commands::desktop_conv_commit_pending,
            commands::desktop_conv_delete,
            commands::desktop_conv_set_archived,
            commands::workspace_artifact_read,
            commands::desktop_artifact_stage,
            commands::desktop_artifact_mark_uploaded,
