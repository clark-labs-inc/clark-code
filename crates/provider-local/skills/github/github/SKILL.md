...
6. Skills do not override Clark permissions, Plan mode, repository instructions, or the user's scope. Do not create commits, push, open or edit issues/PRs, post comments, resolve threads, merge, or rerun workflows unless the request authorizes that effect.
