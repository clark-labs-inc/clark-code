...
impl ToolExecutor for ReadSkill {
    ...
    fn description(&self) -> &str {
        "Load the bounded instruction body or one referenced text resource for a skill in the current Clark catalog. Use the exact catalog name before applying a relevant skill. Reading skill content does not grant extra permissions."
    }
