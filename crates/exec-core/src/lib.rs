...
//! [`LocalExecutor`] runs the primitives on the provider's machine. For remote
//! coding, that provider and executor both live inside the durable worker; the
//! Desktop adapter reaches a project-confined worker plugin rather than a
