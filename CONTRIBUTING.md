# Contributing to Clark Code

Thanks for helping improve Clark Code. Pull requests are welcome, but the
...
- Never commit credentials, personal data, authenticated screenshots, local
  paths, generated release artifacts, or third-party code without compatible
