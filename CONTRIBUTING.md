# Contributing to Clark Desktop

Thanks for helping improve Clark Desktop. Pull requests are welcome, but the
...
- Never commit credentials, customer data, authenticated screenshots, local
  paths, generated release artifacts, or changes copied from private Clark
  repositories.
